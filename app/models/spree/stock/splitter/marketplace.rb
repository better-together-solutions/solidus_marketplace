        ...
        def split(packages)
          ...
          packages.each do |package|
            ...
            fulfilled = package.contents.select { |content|
              ...
              content.variant.suppliers.detect { |supplier|
                supplier.stock_locations_with_available_stock_items(content.variant).empty?
              }
            }
            ...
            supplier_contents = package.contents.select do |content|
              content.variant.suppliers.count > 0 &&
              content.variant.suppliers.detect { |supplier|
                supplier.stock_locations_with_available_stock_items(content.variant).any?
              }
            end
